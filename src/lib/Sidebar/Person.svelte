<script lang="ts">
	...
	$: if (battery_level_sensor) {
		battery_level =
			$states?.[battery_level_sensor]?.state +
			$states?.[battery_level_sensor]?.attributes.unit_of_measurement;
	...
	$: if (battery_level_sensor_2) {
		battery_level_2 =
			$states?.[battery_level_sensor_2]?.state +
			$states?.[battery_level_sensor_2]?.attributes.unit_of_measurement;
...
>
	<div class="Person1">
		...
		<div class="Image">
			<img
				...
				alt="entity_picture"
				style="box-shadow: 0 0 20px {status_color}"
				on:click={handlePerson1Click}
			/>
		</div>
	...
	<div class="Person2">
		...
		<div class="Image">
			<img
				src={entity_2?.attributes.entity_picture}
				alt="entity_picture"
				style="box-shadow: 0 0 20px {status_color_2}"
				on:click={handlePerson2Click}
			/>
		</div>
		<div class="Battery">
			<div class="Icon">
...
<style>
	.container {
		...
		gap: 0px 0px;
		grid-template-areas: 'Person1 Person2';
	}
